...
function LastMonthIncomeBarChart() {
    ...
    const chart = async () => {
      try {
        ...
        const { data } = await axios.get(
          `https://apifinanceme.com/api/Summary/${userID}/income-lastmonth`,
          {
        ...
        setChartData({
          ...
          datasets: [
            {
              label: "Last Month Income Summary $",
...
export default LastMonthIncomeBarChart;
