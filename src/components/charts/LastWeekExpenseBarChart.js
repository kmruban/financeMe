...
function LastWeekExpenseBarChart() {
    ...
    const chart = async () => {
      try {
        ...
        const { data } = await axios.get(
          `https://apifinanceme.com/api/Summary/${userID}/expense-lastweek`,
          {
        ...
        setChartData({
          ...
          datasets: [
            {
              label: "Last Week Expense Summary $",
...
export default LastWeekExpenseBarChart;
