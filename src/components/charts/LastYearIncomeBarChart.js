...
function LastYearIncomeBarChart() {
    ...
    const chart = async () => {
      try {
        ...
        const { data } = await axios.get(
          `https://apifinanceme.com/api/Summary/${userID}/income-lastyear`,
          {
        ...
        setChartData({
          ...
          datasets: [
            {
              label: "Last Year Income Summary $",
...
export default LastYearIncomeBarChart;
