...
function LastYearExpenseBarChart() {
    ...
    const chart = async () => {
      try {
        ...
        const { data } = await axios.get(
          `https://apifinanceme.com/api/Summary/${userID}/expense-lastyear`,
          {
        ...
        setChartData({
          ...
          datasets: [
            {
              label: "Last Year Expense Summary $",
...
export default LastYearExpenseBarChart;
